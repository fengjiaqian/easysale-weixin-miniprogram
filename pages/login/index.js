      ...
      getWXOpenId(wxCode).then(res => {
        ...
        if (res.result == "success" && res.data) {
          ...
          if (bindSuccess) {
            ...
            wx.reLaunch({
              url: `/pages/webview/index?mobileNo=${mobileNo}&token=${encodeURIComponent(token)}&userType=${userType}&shareUserType=${shareUserType}&shareDealerId=${willDealerId}&needGuidance=${needGuidance}&routeRequireGuidance=${routeRequireGuidance}&userState=${userState}&permissionState=${permissionState}`
            })
          } else {
            /*************************** */
